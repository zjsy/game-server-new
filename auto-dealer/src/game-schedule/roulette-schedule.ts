...
export class RouletteTaskPipeline implements TaskPipeline {
  private running: boolean;
  private tasks: Array<Task> = [];
  private tableInfo: TableInfo | null = null;
  private apiService: RouletteApiService;
  constructor(apiService: RouletteApiService) {
  ...
  stop() {
    console.warn("Roulette Task Pipeline Stopped");
    this.running = false;
  }
